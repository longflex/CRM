...
class UsersController extends Controller
{
    ...
    public function index()
    {
    	...
    	# Get all users
    	$users = Laralum::users('isReseller', 1);
    ...
    public function show($id)
    {
    	...
    	# Return the view
    	return view('console/users/show', ['user' => $user]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $row->activation_key = Str::random(25);
        ...
        return redirect()->route('console::users')->with('success', trans('laralum.msg_user_created'));
    }
    ...
    public function edit($id)
    {
        ...
        # Return the view
        return view('console/users/edit', [
            'row'       =>  $row,
            'fields'    =>  $fields,
            'confirmed' =>  $confirmed,
            'empty'     =>  $empty,
    ...
    public function update($id, Request $request)
    {
        ...
        # Return the admin to the users page with a success message
        return redirect()->route('console::users')->with('success', trans('laralum.msg_user_edited'));
    }
    ...
    public function editRoles($id)
    {
    	...
    	# Return the view
    	return view('console/users/roles', ['user' => $user, 'roles' => $roles]);
    }
    ...
    public function setRoles($id, Request $request)
    {
    	...
    	# Return Redirect
        return redirect()->route('console::users')->with('success', trans('laralum.msg_user_roles_edited'));
    }
    ...
    public function destroy($id)
    {
    	...
    	if($id == Laralum::loggedInUser()->id) {
            ...
            return redirect()->route('console::users')->with('success', trans('laralum.msg_user_deleted'));
    	}
    }
    ...
    public function editSettings()
    {
    	...
    	return view('console/users/settings', [
            'row'       =>  $row,
            'fields'    =>  $fields,
            'confirmed' =>  $confirmed,
            'empty'     =>  $empty,
    ...
    public function updateSettings(Request $request)
    {
    	...
    	# Return a redirect
        return redirect()->route('console::users')->with('success', trans('laralum.msg_user_update_settings'));
    }
	...
	public function user_switch_start($new_user)
	{
	  ...
	  Auth::login( $new_user );
	  return redirect()->route('console::console');
	}
    ...
    //    Laralum::permissionToAccess('laralum.users.access');
	   //echo '<pre>';print_r($allcountry);die;
		...
		# check client balance exist or not
		$current_date = date('Y-m-d H:i:s');
		$exist = DB::table('balance')->where('user_id', $id)->exists();
		if(!$exist){
			$insert =  DB::table('balance')->insert(['user_id' =>$id, 'promotional' => 0, 'transactional' => 0, 'description' => 'Test credit added', 'created_at' => $current_date]);			
		}
    	...
    	# Return the view
    	return view('console/users/details', [
    		'users' 	   =>  $users,
    		'balance'      =>  $userBalance,
    ...
    //    Laralum::permissionToAccess('laralum.users.access');
    	# update  users
    	DB::table('users')->where('id', $request->userid )->update(['gateway_assigned' => $request->gateway]);
    	# Return the view
    	 return response()->json(array('success' => true, 'status' => 'success'), 200);
