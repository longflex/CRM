...
$data = [
    ...
    'users' =>  [
        ...
        'table'     =>  'users',
        'create'    =>  [
            'hidden'            =>  ['id', 'su', 'active', 'banned', 'register_ip', 'activation_key', 'locale', 'remember_token','is_openid_access','isReseller', 'reseller_id','alt_email','alt_mobile','default_senderid','gst_no','expiry_date','timezone','created_at', 'updated_at'],
