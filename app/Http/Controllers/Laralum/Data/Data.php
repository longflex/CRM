...
$data = [
    ...
    'users' =>  [
        ...
        'table'     =>  'users',
        'create'    =>  [
            'hidden'            =>  ['id', 'su', 'active', 'banned', 'register_ip', 'activation_key', 'locale', 'remember_token','is_openid_access','isReseller', 'reseller_id','alt_email','alt_mobile','default_senderid','gst_no','expiry_date','branch','department','ivr_access','ivr_uuid','ivr_extension','timezone','created_at', 'updated_at'],
			...
			'relations'         =>  [
                'industry'      =>  [
                   'data'  =>  Laralum::dropdown('industry_select_list'),
                    'value' =>  'value',
                    'show'  =>  'show',
                ],
        ...
        'edit'      =>  [
            'hidden'            =>  ['id', 'su', 'active', 'banned', 'register_ip', 'activation_key', 'locale', 'remember_token','is_openid_access','isReseller', 'reseller_id','alt_email','alt_mobile','default_senderid','gst_no','expiry_date','branch','department','ivr_access','ivr_uuid','ivr_extension','timezone','created_at', 'updated_at'],
            'su_hidden'         =>  ['name', 'active', 'banned', 'password', 'country_code','is_openid_access','isReseller'],
            'empty'             =>  ['password'],
            'default_random'    =>  [],
            'confirmed'         =>  ['password'],
            'encrypted'         =>  [],
    ...
    'profile' =>  [
        ...
        'table'     =>  'users',
        'edit'      =>  [
            'hidden'            =>  ['id', 'su', 'email', 'register_ip', 'active', 'banned', 'activation_key', 'locale', 'remember_token','is_openid_access','isReseller','reseller_id', 'created_at', 'updated_at'],
            'empty'             =>  ['password'],
            'default_random'    =>  [],
            'confirmed'         =>  ['password'],
            'encrypted'         =>  [],
    ...
    'group'  =>  [
        ...
        'table'     =>  'group',
        'create'    =>  [
            'hidden'            =>  ['id', 'client_id', 'created_at', 'updated_at'],
            'default_random'    =>  [],
            'confirmed'         =>  [],
            'encrypted'         =>  [],
            'hashed'            =>  [],
        ...
        'edit'      =>  [
            ...
            'wysiwyg'           =>  [],
            'validator'         =>  [
                'name'  => 'sometimes|required|max:255,'.$row->id,
            ],
        ],
    ],
	...
	'contacts'  =>  [
        ...
        'table'     =>  'contacts',
        'create'    =>  [
            'hidden'            =>   ['id', 'user_id','group_id', 'created_at', 'updated_at'],
            'default_random'    =>  [],
            'confirmed'         =>  [],
            'encrypted'         =>  [],
            'hashed'            =>  [],
	...
	'sender'  =>  [
        ...
        'table'     =>  'sender',
        'create'    =>  [
            'hidden'            =>   ['id', 'user_id','assign_date','approval_date','status','is_default', 'created_at', 'updated_at'],
            'default_random'    =>  [],
            'confirmed'         =>  [],
            'encrypted'         =>  [],
            'hashed'            =>  [],
			...
			'relations'         =>  [
                'service'      =>  [
                    'data'  =>  Laralum::dropdown('service_select_list'),
                    'value' =>  'value',
                    'show'  =>  'show',
                ],
	...
	'bank-details'  =>  [
        ...
        'table'     =>  'bank_details',
        'create'    =>  [
            'hidden'            =>   ['id', 'user_id','role_id','created_at', 'updated_at'],
            'default_random'    =>  [],
            'confirmed'         =>  [],
            'encrypted'         =>  [],
            'hashed'            =>  [],
	...
	'gateways'  =>  [
        ...
        'table'     =>  'gateways',
        'create'    =>  [
            'hidden'            =>   ['id', 'user_id','inboxAPI','param3', 'created_at', 'updated_at'],
            'default_random'    =>  [],
            'confirmed'         =>  [],
            'encrypted'         =>  [],
            'hashed'            =>  [],
			...
			'relations'         =>  [ 	
                'method'      =>  [
                    'data'  =>  Laralum::dropdown('method_select_list'),
                    'value' =>  'value',
                    'show'  =>  'show',
                ],
				
				'enable_smpp'      =>  [
                    'data'  =>  Laralum::dropdown('isSMPP_select_list'),
                    'value' =>  'value',
                    'show'  =>  'show',
                ],
				
				'encode_authentication'      =>  [
                    'data'  =>  Laralum::dropdown('64_encode_select_list'),
                    'value' =>  'value',
                    'show'  =>  'show',
                ],
