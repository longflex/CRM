...
<head>
	...
	<link href="{{ asset(Laralum::publicPath() .'/bootstrap/css/bootstrap.min.css') }}" type="text/css"
		rel="stylesheet">
	<link href="{{ asset(Laralum::publicPath() .'/data_table/dataTables.bootstrap.min.css') }}" type="text/css"
		rel="stylesheet">
	<link href="{{ asset(Laralum::publicPath() .'/data_table/data_table_pagination.css') }}" type="text/css"
		rel="stylesheet" />
...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					<li class="{{ request()->is('ivr/admin') ? 'active' : '' }}">
						<a href="{{ route('Ivr::dashboard') }}"><i class="fas fa-tachometer-alt"></i>Dashboard</a>
					</li>
					<li class="{{ request()->is('ivr/admin/followup') ? 'active' : '' }}">
						<a href="{{ route('Ivr::followup') }}"><i class="far fa-list-alt"></i>Followup</a>
					</li>
					<li class="{{ request()->is('ivr/admin/logs') ? 'active' : '' }}">
						<a href="{{ route('Ivr::logs') }}"><i class="fas fa-headset"></i>Logs</a>
					</li>
					<li class="{{ request()->is('ivr/admin/reports') ? 'active' : '' }}">
						<a href="{{ route('Ivr::reports') }}"><i class="fas fa-chart-line"></i>Reports</a>
					</li>
					<li class="{{ request()->is('ivr/admin/remarketing') ? 'active' : '' }}">
						<a href="{{ route('Ivr::remarketing') }}"><i class="fas fa-bullhorn"></i>Remarketing</a>
					</li>
					<li class="{{ request()->is('ivr/admin/manage') ? 'active' : '' }}">
						<a href="{{ route('Ivr::manage') }}"><i class="fas fa-th-list"></i>Manage</a>
					</li>
				</ul>
	...
	<script src="{{ asset(Laralum::publicPath() .'/data_table/jquery.dataTables.min.js') }}" type="text/javascript">
	</script>
	<script src="{{ asset(Laralum::publicPath() .'/data_table/dataTables.bootstrap.min.js') }}" type="text/javascript">
	</script>
...
$(document).on('click','.deleteGroup',function(){
	...
	<!--new-time-picker-->
	<link href="{{ asset(Laralum::publicPath() .'/time-picker/bootstrap-material-datetimepicker.css') }}"
		type="text/css" rel="stylesheet">
	<script type="text/javascript" src="http://momentjs.com/downloads/moment-with-locales.min.js"></script>
	<script src="{{ asset(Laralum::publicPath() .'/time-picker/bootstrap-material-datetimepicker.js') }}"
