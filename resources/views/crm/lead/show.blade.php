											...
											<div class="max">
												<div class="add_card" onclick="makePermanent(this)" data_id=""
													...
													<div style="float: left">
														<div class="para">
															<label class="ouline">Address</label>
															<p class="margin1">{{ $lead->address ?? '' }}</p>
														</div>
														<div class="para">
															<label class="ouline">District</label>
															<p class="margin2">{{ $lead->district ?? '' }}
															</p>
														</div>
														<div class="para">
															<label class="ouline">State</label>
															<p class="margin3">{{ $lead->state ?? '' }}
															</p>
														</div>
														@if(!empty($countries))
														<div class="para">
															<label class="ouline">Country</label>
															<p class="margin4">{{ $lead->countries ?? '' }}
															</p>
														</div>
														@else <p></p>
														@endif
									...
									<table class="ui five column table">
										...
										<tbody>
											...
											<tr>
												...
												<td>
												<?php
												echo ($members->member_relation_dob != '1970-01-01' && $members->member_relation_dob != '0000-00-00') ? date("jS F, Y", strtotime($members->member_relation_dob)) : '';
												?>
												</td>
