...
<div class="ui one column doubling stackable grid container mb-20">
	<div class="column row pb-0 rmb-20">
		...
		<div class="col-md-9 text-right rmb-20">
			...
			<form class="form-inline">
				...
				@if(Laralum::hasPermission('laralum.member.list'))
				<a href="{{ route('Crm::leads') }}" class="btn btn-primary mr-5"><i class="fas fa-eye"></i> <span
						class="r-none">{{ trans('laralum.view_members') }}</span></a>
				@endif
				@if(Laralum::hasPermission('laralum.donation.view'))
				<a href="{{ route('Crm::donations') }}" class="btn btn-primary mr-5"><i class="fas fa-eye"></i> <span
						class="r-none">{{ trans('laralum.view_donation_title') }}</span></a>
				@endif
				...
				<a href="{{ route('Crm::leads_create') }}" class="btn btn-primary"><i class="fas fa-plus-circle"></i>
					<span class="r-none">{{ trans('laralum.add_members') }}</span></a>
				@endif
			</form>
		</div>
	</div>
