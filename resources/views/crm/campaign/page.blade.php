                    ...
                    <div class="col-md-12">
                        <div class="full-width boxinfo-head p-y-0"> 
                            <?php //print_r($campaignValue); die;?>
                                ...
                                ?>
                                <div class="row" style="margin: 20px; border: 1px solid gray; border-radius: 10px;" id="id">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <div style="padding: 10px;">
                                                        <p>
                                                            <a href="{{route('Crm::view-campaign',$campValue['id'])}}" style="color: rgb(66, 141, 66);">
                                                                <i class="fas fa-eye"></i> View
                                                            </a>
                                                        </p>
                                                        <p>
                                                            <a href="{{route('Crm::edit-campaign',$campValue['id'])}}" style="color: rgb(228, 188, 11);">
                                                                <i class="fas fa-edit"></i> Edit
                                                            </a>
                                                        </p>
                                                        <p>
                                                            <a href="javascript:void(0);" data-id="{{$campValue['id']}}" style="color: rgb(165, 11, 5);">
