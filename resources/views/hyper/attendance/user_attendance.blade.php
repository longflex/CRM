        ...
        <tr>
            ...
            <td>
                ...
                @elseif($dateData['leave'])
                    ...
                    <label class="label label-primary">On Leave</label><br><br>
                    <label class="label label-warning">HalfDay Mark Time</label>
                    @else
                        <label class="label label-primary">On Leave</label>
                    @endif
                @else
