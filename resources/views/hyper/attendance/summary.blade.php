    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="nav nav-tabs nav-justified nav-bordered mb-3">
                <li class="nav-item">
                    <a href="{{ route('Crm::attendance.summary') }}" aria-expanded="true" class="nav-link active">
                        <i class="mdi mdi-account-circle d-md-none d-block"></i>
                        <span class="d-none d-md-block">Summary</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('Crm::attendance') }}" aria-expanded="false" class="nav-link">
            ...
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group mt-1">
                                            ...
                                            <button type="button" id="apply-filter" class="btn btn-info btn-block">Apply</button>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="white-box">
                               <strong>Note:</strong> <i class="fa fa-star text-warning"></i> <i class="uil-arrow-right font-20"></i> Holiday  |  <i class="fa fa-check text-success"></i> <i class="uil-arrow-right font-20"></i> Present | <i class="fa fa-times text-danger"></i> <i class="uil-arrow-right font-20"></i> Absent
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    function showTable() {
        ...
        //refresh counts 
        var url = "{{ route('Crm::attendance.summaryData') }}";
        ...
        .done(function(data) {
            ...
            if(data.status==true){
                $('#attendance-data').html(data.data);
            }
    ...
    $('#attendance-data').on('click', '.edit-attendance',function (event) {
        ...
        var url = '{!! route('Crm::attendance.mark', [':userid',':day',':month',':year',]) !!}';
