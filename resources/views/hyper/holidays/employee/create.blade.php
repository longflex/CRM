...
<div class="modal-footer">
    ...
    <button type="button" onclick="storeHolidays()" class="btn btn-info save-event waves-effect waves-light"><i class="fa fa-check"></i> Save
    </button>
</div>
...
<script>
    ...
    function storeHolidays(){
        ...
        $('#errorOccasion').html('');
        $('.help-block').remove();
        var url = "{{ route('Crm::staff.holidays.store') }}";
        $.easyAjax({
            type: 'POST',
            url: url,
