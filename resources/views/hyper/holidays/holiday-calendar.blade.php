                ...
                <div class="card-body">
                    ...
                    <div class="row bg-title">
                        <div class="col-lg-12 col-sm-12 col-md-12 col-xs-12 text-right">
                            <a onclick="showAdd()" class="btn btn-outline btn-success btn-sm m-l-5">Add Holiday <i class="fa fa-plus" aria-hidden="true"></i></a>
                        </div>
                    </div>
...
<script>
    ...
    var getEventDetail = function (id) {
        var url = '{{ route('Crm::holidays.show', ':id')}}';
...
<script>
    ...
    function setMonthData(d){
        ...
        var year = "{{ $year }}";
        var url = "{{ route('Crm::holidays.calendar-month') }}?startDate="+encodeURIComponent(firstDay)+"&year="+year;
