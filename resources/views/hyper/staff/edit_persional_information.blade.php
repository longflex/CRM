...
<div class="px-2">
    ...
    <div class="row">
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title mb-3">Persional Information</h4><hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="dob" name="dob" value="{{ (isset($user_detail) ? $user_detail->dob : '') }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Age</label>
                                    <input type="text" class="form-control" id="age" name="age" value="{{ (isset($user_detail) ? $user_detail->age : '') }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group ">
   ...
   function remove_inclusions(sl){
    ...
    $(document).ready(function () {
        $('.staff_update').submit(function (e) {
            ...
            my_url = "{{ route('Crm::Update_persional_information') }}";
            var type = "POST";
            $.ajax({
                type: type,
                url: my_url,
