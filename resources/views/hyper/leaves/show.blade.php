<div id="event-detail">
        ...
        <div class="form-body">
            ...
            <div class="row">
                <div class="col-xs-12 ">
                    <div class="form-group">
                        <label>Date</label>
                        <p>{{ $leave->leave_date->format('d-m-Y') }}
    ...
    <div class="modal-footer">
        ...
        <button type="button" class="btn btn-info save-event waves-effect waves-light"><i class="fa fa-edit"></i> Edit
        </button>
    </div>
...
<script>
    ...
    $('.save-event').click(function () {
        $.easyAjax({
            url: '{{route('Crm::leaves.edit', $leave->id)}}',
    ...
    $('.delete-event').click(function(){
        ...
        const swalWithBootstrapButtons = Swal.mixin({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('Crm::leaves.destroy',$leave->id) }}";
                    //url = url.replace(':id', $leave->id);
