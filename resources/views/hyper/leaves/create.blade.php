    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Leaves Create</h4>
            </div>
        </div>
    </div>     
    <!-- end page title --> 
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 m-t-10">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 form-control" data-placeholder="Choose Members" name="user_id">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label class="control-label">Leave Type 
                                                            <a href="javascript:;"  id="addLeaveType" class="btn btn-sm btn-outline btn-success"><i class="fa fa-plus"></i> Add Leave Type</a>
                                                        </label>
...
<script>
    ...
    $("#createLeave").submit(function(event){
