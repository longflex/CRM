            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('Crm::leads') }}">List</a></li>
                ...
                <div class="card-body">
                    <form id="addForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control select2" id="lead_status" name="lead_status" data-toggle="select2" data-placeholder="Please select..">
                                        ...
                                        <option value="{{ $lead_status->lead_status }}"
                                            {{ (old('lead_status') == $lead_status->lead_status ? 'selected': '') }}>
                                        ...
                                        <!-- <option value="2" {{ (old('lead_status') == "2" ? 'selected': '') }}>Open</option>
                                        <option  value="1" {{ (old('lead_status') == "1" ? 'selected': '') }}>Assigned</option>
                                        <option value="3" {{ (old('lead_status') == "3" ? 'selected': '') }}>Converted</option>
                                        <option value="4" {{ (old('lead_status') == "4" ? 'selected': '') }}>Follow Up</option>
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control select2" id="preferred_language" name="preferred_language" data-toggle="select2" data-placeholder="Please select..">
                                        ...
                                        <option value="{{ $preferred_language->preferred_language }}"
                                            {{ (old('preferred_language') == $preferred_language->preferred_language ? 'selected': '') }}>
                            ...
                            @if(Laralum::permissionToAccessModule() === false)
                            <div class="col-lg-3">
                                <div class="form-group" >
                                    <label>Member Type</label>
                                    <select class="select2 form-control select2-multiple" name="member_type[]" id="member_type_id" data-toggle="select2" multiple="multiple" data-placeholder="Please select..">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" style="text-align:center;" id="member_id" name="member_id" required readonly value="{{ $company }}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-lg-10">
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group" id ="branch_dropdown">
                                            <label>Branch</label>
    ...
    .done(function(data) {
        ...
        if(data.status==true){
            ...
            setTimeout(function(){
                ...
                var url = "{{route('Crm::lead_details', '')}}"+"/"+data.id;
                location.href=url;
            }, 3500);
        }
...
//     $(this).data('options', $('#lead_status option').clone());
//   }
//   var id = $(this).val();
// //   var options = $(this).data('options').filter('[value=' + id + ']');
//   $('#lead_status').html(options);
// });
