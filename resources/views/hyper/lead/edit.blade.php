                            ...
                            <div class="col-md-3">
                                <div class="form-group ">
                                    ...
                                    <select class="form-control select2" id="lead_status" name="lead_status" data-toggle="select2" data-placeholder="Please select..">
                                        ...
                                        @endif
                                        <option value="add">Add Value</option>
                                        <!-- <option value="2" {{ old('lead_status',$lead->lead_status == 2 ? 'selected': '') }}>Open</option>
                                        <option value="1" {{ old('lead_status',$lead->lead_status == 1 ? 'selected': '') }}>Assigned</option>
                                        <option value="3" {{ old('lead_status',$lead->lead_status == 3 ? 'selected': '') }}>Converted</option>
                                        <option value="4" {{ old('lead_status',$lead->lead_status == 4 ? 'selected': '') }}>Follow Up</option>
                                        <option value="5" {{ old('lead_status',$lead->lead_status == 5 ? 'selected': '') }}>Closed</option>  -->           
                                    </select>
                                </div>
                            </div>
