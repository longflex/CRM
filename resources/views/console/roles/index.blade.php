...
<div class="px-5">
    ...
    <div class="row">
        <ul class="nav nav-tabs mb-3">
            ...
            <li class="nav-item">
                <a href="#Genaral" data-toggle="tab" aria-expanded="true" class="nav-link ">
    ...
    <div class="tab-content">
            ...
            <div  class="container-fluid ">
                <div class="container-fluid">
                    <div class="d-flex flex-row-reverse">
                        ...
                        <a href="#" class="ui teal submit button" id="addRazorPayDetails" data-toggle="modal" data-target="#AddRazorPay"><i class="uil-plus-circle"></i>&nbsp;Add RazorPay
                        </a>
                        @endif
                    </div>  
                    <div class="card"> 
        ...
        <div id ="Roles" class="tab-pane fade">
            <div  class="container-fluid ">
                <div class="container-fluid">
                    <a href="{{ route('console::roles_create') }}" class="btn btn-sm btn-primary mt-1 mb-2"><i class="uil-plus-circle"></i>Create Role</a>
                    <div class="card">
                        <div class="card-body">
                            <table class="table table-bordered table-centered mb-0">
                                <thead>
    ...
    $('#upload_organization_form').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // swal({
                //     title: "Success!",
                //     text: "The organization profile has been updated!",
                //     type: "success"
                // }, function () {
                //     //location.reload();
                // });
    ...
    $('#upload_branch_form').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // swal({
                //     title: "Success!",
                //     text: "The branch " + branch + " has been created!",
                //     type: "success"
                // }, function () {
                //     location.reload();
                // });
    ...
    $('#update_branch_form').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //$(".editBranchForm").css('display', 'none');
                //$("#hidebutext").css('display', 'inline-block');
                // swal({
                //     title: "Success!",
    ...
    $('#upload_department_form').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // swal({
                //     title: "Success!",
                //     text: "The department " + department + " has been created!",
                //     type: "success"
                // }, function () {
                //     location.reload();
                // });
    ...
    $(document).on('click', '#savePurpose', function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // swal({
                //     title: "Success!",
                //     text: "The Donation details has been submited!",
                //     type: "success"
                // }, function () {
                //     location.reload();
                // });
    ...
    $('#upload_bank_form').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // swal({
                //     title: "Success!",
                //     text: "The bank details has been created!",
                //     type: "success"
                // }, function () {
                //     location.reload();
                // });
    ...
    $('#upload_razorpay_form').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                // swal({
                //     title: "Success!",
                //     text: "The RazorPay details has been created!",
                //     type: "success"
                // }, function () {
                //     location.reload();
                // });
    ...
    $('#update_timeslot_form').submit(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //$(".editTimeSlotForm").css('display', 'none');
                //$("#hideetstext").css('display', 'inline-block');
                // swal({
                //     title: "Success!",
