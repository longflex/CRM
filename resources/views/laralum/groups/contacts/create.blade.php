...
@section('breadcrumb')
    <div class="ui breadcrumb">
        ...
        <i class="right angle icon divider"></i>
        <div class="active section">{{ trans('laralum.create_contact') }}</div>
    </div>
@endsection
@section('title', trans('laralum.create_contact'))
@section('icon', "plus")
@section('subtitle', trans('laralum.create_contact_subtitle'))
@section('content')
