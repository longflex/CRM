...
@section('content')
  ...
  <div class="ui one column doubling stackable grid container">
	...
	<a href="{{ route('Laralum::roles_create') }}" class="res_ex ui {{ Laralum::settings()->button_color }} button">
    <i class="fa fa-plus icon_m" aria-hidden="true"></i><span>{{ trans('laralum.create_role') }}</span></a>
	@endif
